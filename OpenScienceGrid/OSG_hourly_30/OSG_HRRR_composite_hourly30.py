...
# Archvie Date Range
sDATE = datetime(2015, 6, 1, hour)
eDATE = datetime(2017, 9, 1, hour)
...
try:
    if len(requestDATES) != 0:
        ...
        # Limit the maximum multiprocessing amoun to 8. Having more than 8 does not increase download speed.
    ...
    print '!!! Something is wrong. Exit with exit code 74'
    sys.exit(os.EX_IOERR)
