...
for info, shape in zip(m.perim_info, m.perim):
    ...
    if info['FIRENAME']== 'PIONEER' and info['PERDATTIME']==[2016,9,9] and np.shape(shape)[0]>6000: # and info['SHAPENUM']==1914:
        x, y = zip(*shape) 
...
hrrr_dir = '/uufs/chpc.utah.edu/common/home/horel-group/archive/20161005/models/hrrr/'
...
plt.savefig(SAVEDIR+'PioneerFire_LandUse_VALUES_20160805_'+save_name+'_NASA.png',bbox_inches='tight')
